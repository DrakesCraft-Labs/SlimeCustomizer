...
/**
 * Modified {@link com.github.drakescraft_labs.slimefun4.legacy.Objects.SlimefunItem.abstractItems.AGenerator} class
 *
...
public abstract class SCAGenerator extends AbstractEnergyProvider implements MachineProcessHolder<FuelOperation> {
    ...
    protected BlockBreakHandler onBlockBreak() {
        return new SimpleBlockBreakHandler() {
            ...
            public void onBlockBreak(Block b) {
                BlockMenu inv = Almacen.getMenu(b.getLocation());
    ...
    public int getGeneratedOutput(Location l, Config data) {
        BlockMenu inv = Almacen.getMenu(l);
