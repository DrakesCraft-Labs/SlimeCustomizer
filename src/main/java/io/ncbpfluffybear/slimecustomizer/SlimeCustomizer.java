...
public class SlimeCustomizer extends JavaPlugin implements SlimefunAddon {
    ...
    public void onEnable() {
        ...
        // Aqui habia una guardia que desactivaba el plugin si no encontraba GuizhanLibPlugin, y
        // mandaba al administrador a descargarlo desde un acortador de enlaces (50l.cc), que puede
        // apuntar a cualquier sitio y cambiar de destino sin que se note.
        //
        // Sobra por partida doble: este port ya no usa esa libreria -- lo que se usaba de ella
        // esta reimplementado dentro de este mismo jar --, y GuizhanLibPlugin no esta instalado en
        // DrakesCraft, asi que la guardia se habria disparado y el addon no habria arrancado.
    ...
    public String getBugTrackerURL() {
        return "https://github.com/DrakesCraft-Labs/SlimeCustomizer/issues";
    }
